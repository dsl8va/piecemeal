...
## Heading ##
  > Piecemeal - cooking made easy.

## Sub-Heading ##
  > Designed with every cook in mind.
...
## Solution ##
  > Enter Piecemeal - the cooking application designed with every cook in mind. Piecemeal gives you, the user, the power to make all the decisions!

## How to Get Started ##
  > Start with a basic search to see how the application works. From there, explore the different kinds of custom searches you can make!

## Closing and Call to Action ##
  > Go check out the site and explore all the possibilities. Let's get cooking!.