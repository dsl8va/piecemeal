...
//   return {
//     props: {
//       title1, image1, title2, image2, title3, image3
//     },
//     revalidate: 86400,
//   }
// }
...
export default function Home({title1, image1, title2, image2, title3, image3}) {
  return (
    <Container>
      <Head>
      ...
      <CardDeck>
        <CardTemplate title={title1} image={image1}/>
        <CardTemplate title={title2} image={image2}/>
        <CardTemplate title={title3} image={image3}/>
